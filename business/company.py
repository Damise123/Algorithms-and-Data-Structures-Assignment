class Company:
    ...
    def total_revenue(self):
        print("total_revenue method needs to be implemented...")
        return 0
    def get_top_sales(self, sorter, n=10):
# Step 1: Use the sorting algorithm
        sorted_sales = sorter.sort(self.__sales,key=lambda x: x.total_sales)
        # Step 2: Collect top N using backward while loop
        top_sales = []
        index = len(sorted_sales) - 1 # Start at lastelement
